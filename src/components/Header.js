...
export function renderHeader(activePage, onSettingsClick) {
    ...
    <div class="header__inner">
      <a href="#/" class="header__brand"><img src="/assets/bcc.ico" alt="BCC Logo" class="header__logo" /><span class="header__brand-wordmark">Blessings<span class="header__brand-accent">365</span></span></a>
      <div class="header__actions">
        ...
        <a href="/print/" class="header__print-link" aria-label="Open print page" title="Open print page">
